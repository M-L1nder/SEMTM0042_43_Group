...
const float wheel_radius  = 16.2*100/96.85*100/101.48*100/99.84;;
const float wheel_sep     = 45*168.8/180*348/360*371.45/360 ;  // mm, from centre of robot to wheel centre
